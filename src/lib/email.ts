// Email service — Agendaê (premium templates v2)
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tr>
                    <td style="padding:32px 32px 28px;">
                      <div style="font-size:22px;font-weight:700;color:#ffffff;letter-spacing:-0.02em;line-height:1;">
                        meagendaê
                      </div>
                      <div style="margin-top:6px;font-size:12px;color:rgba(255,255,255,0.75);letter-spacing:0.02em;">
            ...
            <tr>
              <td style="padding:20px 32px 28px;border-top:1px solid ${BRAND.border};background:${BRAND.surface};">
                <p style="margin:0;font-size:12px;line-height:1.6;color:${BRAND.muted};text-align:center;">
                  ...
                  <span style="color:#94a3b8;">Você recebeu este e-mail porque tem uma conta no Agendaê.</span>
                </p>
              </td>
            </tr>
          </table>
...
/** Pick an interpretation message based on revenue + profit. */
function getInsight(data: MonthlyReportData): { emoji: string; title: string; text: string; tone: "good" | "neutral" | "low" } {
