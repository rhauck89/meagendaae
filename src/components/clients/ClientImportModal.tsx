...
import { Download, Upload, AlertCircle, CheckCircle2, XCircle, Info, Loader2 } from 'lucide-react';
    ...
    case 'incomplete':
      return (
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger>
              <Badge className=\"bg-blue-500/10 text-blue-600 hover:bg-blue-500/10 border-blue-200 gap-1\">
