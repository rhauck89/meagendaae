                    ...
                    <Table className="w-full">
                      <TableHeader className="bg-muted/50">
                        <TableRow>
                          ...
                          <TableHead className="text-[10px] uppercase font-bold px-4 py-3">Origem</TableHead>
                          <TableHead className="text-[10px] uppercase font-bold px-4 py-3">Plano / Serviço</TableHead>
                      ...
                      <TableBody>
                        {loading ? (
                          ...
                          <TableRow>
                            <TableCell colSpan={8} className="text-center text-xs py-12 text-muted-foreground">
                          ...
                          paginatedHistory.map((h: any) => (
                            <TableRow key={h.id} className="hover:bg-muted/30">
                              ...
                              <TableCell className="text-[12px] py-4 px-4">
                                <Badge variant="outline" className={`text-[10px] font-bold ${h.origin === 'Assinatura' ? 'bg-primary/5 text-primary border-primary/20' : ''}`}>
                                  {h.origin}
                                </Badge>
                              </TableCell>
                              <TableCell className="text-[12px] py-4 px-4">
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <Badge variant="outline" className={`text-[8px] font-bold h-4 px-1 ${h.origin === 'Assinatura' ? 'bg-primary/5 text-primary border-primary/20' : ''}`}>
                                {h.origin}
                              </Badge>
                            </div>
