-- 20260514173500_add_client_email_to_appointments.sql
...
-- 20260514171238_5c79e4a4-73a3-4e4c-9d1f-b560ad1e6313.sql
DO $$ 
BEGIN 
...
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'plan_modules' AND policyname = 'Public can view active modules') THEN
...
-- 20260514170000_fix_staff_salary_and_subscription_commissions.sql
